...
let miFunction2 = function (a, b) {
    return a + b;
};
let miFuncion2Flacha = (a, b) => a + b;
let miFuncion3 = function (nombre) {
    nombre = nombre.toUpperCase();
    return nombre;
};
let miFuncion3Flecha = (nombre) => {
    nombre = nombre.toUpperCase();
    return nombre;
};
